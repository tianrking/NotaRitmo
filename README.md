...
graph TB
    ...
    subgraph ENG["⚙️ 引擎层 · Engine"]
        ...
        LLM["OpenAiCompatibleLlmClient<br/>可选摘要"]
    ...
    class RT,REF,DIA,VAD,VP,PUNC,OAT,LLM,DL,ENG engine
...
| 🟩 **标点恢复** | `sherpa-onnx-punct-ct-transformer-zh-en-vocab272727-2024-04-12` | `model.int8.onnx` | 补全逗号、句号 |
...
2. 等待进度条完成(应用自动从 Hugging Face 下载,失败回退 `hf-mirror.com`)
3. 下载完成后,**完全离线**可用 ✅
